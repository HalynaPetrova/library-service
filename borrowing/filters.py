...
class BorrowingFilter(filters.FilterSet):
    ...
    borrow_date__lt = django_filters.DateFilter(
        field_name="borrow_dat", lookup_expr="lt"
    )
    borrow_date__gt = django_filters.DateFilter(
        field_name="borrow_date", lookup_expr="gt"
    )
